...
#define SIM_DICT_CUSTOM_DATA                    @"shipitData"
...
#define STATS_BADGE_CNT                             @"badge_cnt_number"     // Badge Number shown on App.
#define STATS_SEND_INTERVAL                         1420                    // Time interval in minutes
...
@protocol SIM_Delegate <NSObject, UNUserNotificationCenterDelegate>
@optional
@end
...
+ (NSString *) SIM_GetChannelID;
+ (NSDictionary *) SIM_GetLastCustomData;
@end
